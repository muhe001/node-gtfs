...
var _agency = require('../models/_agency');
var _calendar = require('../models/_calendar');
var _calendarDate = require('../models/_calendarDate');
var _fareAttribute = require('../models/_fareAttribute');
var _fareRule = require('../models/_fareRule');
var _feedInfo = require('../models/_feedInfo');
var _frequencies = require('../models/_frequencies');
var _route = require('../models/_route');
var _routeDirection = require('../models/_routeDirection');
var _shape = require('../models/_shape');
var _stop = require('../models/_stop');
var _stopTime = require('../models/_stopTime');
var _trip = require('../models/_trip');
var _timetable = require('../models/_timetable');
...
module.exports = function (db) {
  ...
  var Agency = require('../models/Agency')(esClient);
  var Calendar = require('../models/Calendar')(esClient);
  var CalendarDate = require('../models/CalendarDate')(esClient);
  var FareAttribute = require('../models/FareAttribute')(esClient);
  var FareRule = require('../models/FareRule')(esClient);
  var FeedInfo = require('../models/FeedInfo')(esClient);
  var Frequencies = require('../models/Frequencies')(esClient);
  var Route = require('../models/Route')(esClient);
  var RouteDirection = require('../models/RouteDirection')(esClient);
  var Shape = require('../models/Shape')(esClient);
  var Stop = require('../models/Stop')(esClient);
  var StopTime = require('../models/StopTime')(esClient);
  var Transfer = require('../models/Transfer')(esClient);
  var Trip = require('../models/Trip')(esClient);
  var Timetable = require('../models/Timetable')(esClient);
